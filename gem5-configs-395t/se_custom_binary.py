...
# Create an argument group for simulation settings
sim_args = simarglib.add_parser("Simulation Settings", "Control warmup and max instructions")

# Add arguments for instruction limits
sim_args.add_argument("--max-insts", type=int, default=0, help="Total instructions to simulate")
sim_args.add_argument("--warmup-insts", type=int, default=0, help="Warmup instructions before stats collection")
